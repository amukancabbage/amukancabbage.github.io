...
if (!workbox) {
    workbox.precaching.precacheAndRoute([
        ...
        { url: "/assets/vendor/materialize/css/materialize.min.css", revision: '2' },
        { url: "/assets/vendor/materialize/js/materialize.min.js", revision: '2' },
        { url: "/assets/vendor/jakearchibald/js/idb.js", revision: '2' },
        { url: "/assets/js/api.js", revision: '2' },
        { url: "/assets/js/auth.js", revision: '2' },
        { url: "/assets/js/db.js", revision: '2' },
        { url: "/assets/js/lib.js", revision: '2' },
        { url: "/assets/js/login.js", revision: '2' },
        { url: "/assets/js/nav.js", revision: '2' },
        { url: "/service-worker-register.js", revision: '2' },
