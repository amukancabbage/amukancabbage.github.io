...
if (workbox) {
    workbox.precaching.precacheAndRoute([
        ...
        { url: "/pages/bulanan.html", revision: '4' },
        { url: "/pages/home.html", revision: '4' },
        { url: "/pages/kinerja.html", revision: '4' },
        ...
        { url: "/assets/js/auth.js", revision: '5' },
        { url: "/assets/js/db.js", revision: '4' },
        { url: "/assets/js/lib.js", revision: '6' },
        { url: "/assets/js/login.js", revision: '5' },
        { url: "/assets/js/nav.js", revision: '6' },
